...
/*
 ...
 -------------------------------------
 Cognome e Nome	: Patruno Antonio
 Matricola	: 618133
 -------------------------------------
...
public class ProvaDB20170131 {
	...
	public static void main(String[] args) {
		...
		String stringa6 = "SELECT Nome_autore, Cognome_autore, Titolo_libro, Nome_editore "
						+ "FROM Autori LEFT JOIN LibriAutori ON LibriAutori.Nro_autore = Autori.Nro_autore "
						+ "NATURAL JOIN Editori NATURAL JOIN Libri  "
						+"GROUP BY Autori.Nro_autore "
				    	+ "ORDER BY Autori.Cognome_autore";
		...
		try {
			...
			/*
			 * creazione di una connessione al database HenrysBooksDB20170131
			 * con credenziali di accesso appropriate
			 */
			connessione = DriverManager.getConnection(
					"jdbc:mysql://localhost/henrysbooksdb20150226", "root", "PATRUNO12");
			...
			while (risultato6.next()) {
					nome = risultato6.getString("Nome_autore");
					cognome = risultato6.getString("Cognome_autore");
					titolo = risultato6.getString("Titolo_libro");
					String editore = risultato6.getString("Nome_editore");
					System.out.println("autore: " + nome + "\tcognome: " + cognome + "\ttitolo: " + titolo + "\teditore: " + editore);
			}
